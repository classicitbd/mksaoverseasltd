...
@section('main_content')
        ...
        <div id="rev_slider_one" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
            <ul>
                ...
                <li data-index="rs-70" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="images/slider/slide1-home1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{url('frontend/images/slider/Simg-4.webp')}}" data-bgcolor='rgba(255,255,255,0)' alt=""  data-bgposition="50% 50%" data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    ...
                    <div class="tp-caption tp-resizeme"
                        id="slide-70-layer-2"
                        data-x="['left','left','left','left']" data-hoffset="['15','15','15','15']"
                        data-y="['top','top','top','top']" data-voffset="['150','140','155','145']"
                        ...
                        style="z-index: 10; text-transform: uppercase;  font-weight: 700; color: #ffffff; font-family: Montserrat;">MKsaoverseas<br>LTD.
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme"
                        id="slide-70-layer-3"
                        data-x="['left','left','left','left']" data-hoffset="['15','15','15','15']"
                        data-y="['top','top','top','top']" data-voffset="['320','279','271','235']"
                    ...
                    <div class="tp-caption rev-btn"
                        id="slide-70-layer-4"
                        data-x="['left','left','left','left']" data-hoffset="['15','15','15','15']"
                        data-y="['top','top','top','top']" data-voffset="['425','385','370','320']"
                ...
                <li data-index="rs-71" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="images/slider/slide2-home1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{url('frontend/images/slider/Simg-8.webp')}}" data-bgcolor='rgba(255,255,255,0)' alt=""  data-bgposition="50% 50%" data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        id="slide-70-layer-6"
                        data-x="['left','left','left','left']" data-hoffset="['15','15','15','15']"
                        data-y="['top','top','top','top']" data-voffset="['140','140','155','145']"
                        data-fontsize="['72','60','48','30']"
                        data-lineheight="['80','62','52','42']"
                        data-whitespace="nowrap"
                        ...
                        style="z-index: 10; text-transform: uppercase; font-weight: 700; color: #fff; font-family: Montserrat;">Best Quality<br>Product
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        style="z-index: 10; white-space: normal; color: #fff;font-family: 'Nunito Sans', sans-serif;">From Label to Printing, MKsaoverseas LTD. Is your<br> is your global brand Printing and woven trim and accessories solution.
                    </div>
                ...
                <li data-index="rs-72" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="images/slider/slide3-home1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{url('frontend/images/slider/Simg-7.webp')}}" data-bgcolor='rgba(255,255,255,0)' alt=""  data-bgposition="50% 50%" data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        style="z-index: 10; text-transform: uppercase; font-weight: 700; color: #fff; font-family: Montserrat;">WE HAVE THE BEST <br>MACHINERIS
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        style="z-index: 10; white-space: normal; color: #fff;font-family: 'Nunito Sans', sans-serif;">We have the best machines for each section<br>originated from both Internationally and Domestically.</div>
                ...
                <div class="col-lg-12">
                    <div class="project-filter-wrapper">
                        <ul class="project_filters">
                            ...
                            <li><a href="" data-filter=".1">Printed Wrapper</a></li>
                            <li><a href="" data-filter=".2">Laminated Wrapper</a></li>
                            <li><a href="" data-filter=".3">Pearl BOPP Wrapper</a></li>
                            <li><a href="" data-filter=".4">LDPE Shrinkable Film Wrapper</a></li>
                            <li><a href="" data-filter=".5">Single Layer Bopp Wrapper</a></li>
                            <li><a href="" data-filter=".6">Paper Printing</a></li>
                        </ul>
    ...
    <div class="no-padding">
        <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.4078569317007!2d90.4095507260226!3d23.732830989449297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b9a4977b2ac9%3A0x97172ca3a26dd4a5!2sJaman%20Tower!5e0!3m2!1sen!2sbd!4v1730708518369!5m2!1sen!2sbd" width="1800" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
    </div>
