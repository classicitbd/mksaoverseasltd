    ...
    <div class="page-header flex-middle">
        <div class="container">
            <div class="inner flex-middle">
                <h1 class="page-title" style="font-weight:600;">E-Commerce</h1>
                ...
                <div class="widget-area primary-sidebar col-lg-3 col-md-12 col-sm-12">
                    ...
                    <aside class="widget widget_products">
                        ...
                        <ul class="popular-product clearfix">
                            <li class="clearfix"> 
                                <div class="thumb">
                                    <a href="single-product.html"><img src="{{url('frontend/images/product/product-3.jpg')}}" alt=""></a>
                                </div>
                            ...
                            <li class="clearfix"> 
                                <div class="thumb">
                                    <a href="single-product.html"><img src="{{url('frontend/images/product/product-6.jpg')}}" alt=""></a>
                                </div>
                                <div class="entry-header">
                            ...
                            <li class="clearfix"> 
                                <div class="thumb">
                                    <a href="single-product.html"><img src="{{url('frontend/images/product/product-5.jpg')}}" alt=""></a>
                                </div>
                                <div class="entry-header">
                        ...
                        <div class="row">
                                ...
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            ...
                                            <img src="{{url('frontend/images/product/product-2.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6 last">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-3.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6 first">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-4.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-5.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6 last">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <span class="onsale">Sale!</span>
                                            <img src="{{url('frontend/images/product/product-6.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6 first">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <span class="onsale">Sale!</span>
                                            <img src="{{url('frontend/images/product/product-7.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-8.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6 last">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-9.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6 first">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-10.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-11.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
                            ...
                            <div class="col-md-4 col-sm-6 last">
                                <div class="product-item">
                                    <div class="product-media"> 
                                        <a href="single-product.html">
                                            <img src="{{url('frontend/images/product/product-12.jpg')}}" class="" alt="">
                                        </a>
                                        <div class="wrapper-add-to-cart">
                                            <div class="add-to-cart-inner">
                                                <a href="cart.html" class="octf-btn octf-btn-primary">Add to cart </a>           
